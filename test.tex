...
\zchinrsetup{
  ...
  article = {
    ...
    title        = {Langer Titel},
    title short  = {Kurzer Titel},
    title alt    = {English Title},
    author       = {Vorname Name},
    author short = {Name},
    author note  = {PhD in law.},
...
Als Gregor Samsa\footnote{\zhs{促进和规范数据跨境流动规定} (wörtlich: Bestimmungen zur Förderung und Normierung des grenzüberschreitenden Umlaufs von Daten) vom 22.3.2024, chinesisch-deutsch in diesem Heft, S.~159~ff.} eines Morgens aus unruhigen Träumen erwachte, fand er sich in seinem Bett zu einem ungeheueren Ungeziefer verwandelt. Er lag auf seinem panzerartig harten Rücken und sah, wenn er den Kopf ein wenig hob, seinen gewölbten, braunen, von bogenförmigen Versteifungen geteilten Bauch, auf dessen Höhe sich die Bettdecke, zum gänzlichen Niedergleiten bereit, kaum noch erhalten konnte. Seine vielen, im Vergleich zu seinem sonstigen Umfang kläglich dünnen Beine flimmerten ihm hilflos vor den Augen.
...
\zchinrsetup{
  ...
  article = {
    doi          = {10.1080/10192557.2019.1651486},
    title        = {Ein anderer langer Titel},
    title short  = {Ein anderer kurzer Titel},
...
\documentationheader[l]{\zhs{某个规定}} & \documentationheader[l]{Als Gregor Samsa eines Morgens aus unruhigen Träumen erwachte} \\

\zhs{\textbf{第一条}　某个规定。} & \textbf{§~1} Als Gregor Samsa\footnote{\zhs{促进和规范数据跨境流动规定} (wörtlich: Bestimmungen zur Förderung und Normierung des grenzüberschreitenden Umlaufs von Daten) vom 22.3.2024, chinesisch-deutsch in diesem Heft, S.~159~ff.} eines Morgens aus unruhigen Träumen erwachte, fand er sich in seinem Bett zu einem ungeheueren Ungeziefer verwandelt. \\

\zhs{\textbf{第一条}　某个规定。} & Foo \\

\zhs{\textbf{第一条}　某个规定。} & Baz \\
...
\begin{addresses}
  \addressesheader{Baker \& McKenzie}[section] & \addressesheader{\zhs{贝壳·麦坚时国际律师事务所北京代表处}} \\
  ...
  \zhs{中国国际贸易中心} \newline 
  \zhs{建国门外大街 1 号} \newline
  \zhs{100004 北京, 中华人民共和国} \\
  \addressesspan{Tel.: +86 10 6535 3800 \addressessep Fax: +86 10 6505 2309, +86 10 6505 0378 \newline 
  E-Mail: \email{christian.atzler@bakermckenzie.com} \newline
  Ansprechpartner: \emph{Christian Atzler}} \\
  %  
  \addressesheader{Brandi Dröge Piltz Heuer \& Gronemeyer} & \\
  Suite 706/2, Jian Wai SOHO \newline
  No. 39, East 3rd Ring Road, Chaoyang District  \newline
  100022 Beijing, VR China & 
  \zhs{建外 SOHO 2 号楼 706 室} \newline
  \zhs{朝阳区东三环中路 39 号} \newline
  \zhs{100022 北京, 中华人民共和国} \\
  \addressesspan{Tel.: +86 10 5869 5751 \addressessep E-Mail: \email{wigginghaus@bdphg.de} \newline
  Ansprechpartner: \emph{Dr. Nils Wigginghaus}} \\
\end{addresses}
...
\begin{imprint}
  ...
  E-Mail: \email{glatter@dcjv.org} & \textsf{\textbf{ISSN: 1613-5768}} \newline \textsf{\textbf{Online ISSN: 2366-7125}} \\ 
