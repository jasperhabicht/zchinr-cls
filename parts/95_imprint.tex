...
\begin{imprint}
  ...
  Jasper Habicht, Köln & \\
   ...
   & \imprintspan{Ab dem Jahrgang 2025 werden alle ZChinR-Beiträge unter der Creative-Commons-Lizenz CC BY 4.0 veröffentlicht. Weitere Informationen zur Lizenz unter \url{creativecommons.org/licenses/by/4.0/}.} \\
      
   & \imprintspan{Unter \url{www.ZChinR.org} stehen alle Beiträge seit 2004 als Volltexte im text- und seitenkonkordanten PDF-Format zur Verfügung.} \\
